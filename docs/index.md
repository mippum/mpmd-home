---
description: 외우고 싶은 문장을 반복해서 들려주는 듣기 트레이너와 한 문제씩 답을 확인하며 푸는 퀴즈, TTS 반복학습용 전자책을 제공하는 미쁨에듀 온라인입니다.
hide:
  - toc
---
...
<div style="display: grid;
  ...
  <!-- 카드 1 -->
  <a href="/service/quiz/?fileUrl=/assets/webs/content/service/quiz/samples/korean-spelling.mpqz.json" 
      style="
        background:#f7e7a1;
  ...
  <!-- 카드 4 -->
  <a href="/service/quiz?fileUrl=/assets/webs/content/service/quiz/samples/country-capital-quiz.json" 
      style="
        background:#f3c5e6; 
        text-decoration: none;
        color: inherit;
